...
public class DBhelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		// 下面表控制注册
		db.execSQL("CREATE TABLE [dt_users] ([id] INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,[username] VARCHAR(500),[pass] BOOLEAN,[password] VARCHAR(100),[qq] VARCHAR(50),[email] VARCHAR(50));");
